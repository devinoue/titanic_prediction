...
# 機械学習の基礎用として用意されたもので、学習用データは891個のデータから、1を生存者、0を故人として学習させます。この学習モデルから予測したデータをCSV形式にしてサイトにアップロードすると、ランキングとして表示されます。
# 
# 
...
# 
# 残念ながら今回の正解率は **75%** でした。  
# それ以前に何度か試していましたが、最高正解率は**78%** で、上位41%ほどです。ベースラインである76%は超えていますが、正直に言えばまだまだというところでした。  
...
# [AI 機械学習コンペ タイタニック号の生存者予測 に参加してみた](http://d.hatena.ne.jp/knaka20blue/20180110)  
# [Kaggle入門【Titanic】 可視化](https://www.munemakun.net/entry/kaggle/titanic/graph)  
